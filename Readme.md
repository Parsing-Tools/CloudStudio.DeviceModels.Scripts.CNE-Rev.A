...
# Parsing + Configuration Script – CNE - Rev. A

This **Parsing + Configuration** script is designed for the **CNE** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – CNE Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **CNE** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
